enum BookingStatus { paymentPending, confirmed, checkedIn, completed, cancelled, expired }
...
class Booking {
  ...
  factory Booking.fromJson(Map<String, dynamic> json) => Booking(
        ...
        bookingType: BookingTypeX.fromApi(json['bookingType'] as String? ?? 'MONTHLY'),
        moveInDate: DateTime.parse((json['checkInDate'] ?? json['moveInDate']) as String),
        checkOutDate: json['checkOutDate'] == null ? null : DateTime.parse(json['checkOutDate'] as String),
        rentAmount: (json['rentAmount'] as num? ?? 0).toDouble(),
        securityDepositAmount: (json['securityDepositAmount'] as num? ?? 0).toDouble(),
        totalAmount: (json['totalAmount'] as num? ?? 0).toDouble(),
        paymentExpiresAt: json['paymentExpiresAt'] == null ? null : DateTime.parse(json['paymentExpiresAt'] as String),
        ...
        plannedMoveOutDate: json['plannedMoveOutDate'] == null ? null : DateTime.parse(json['plannedMoveOutDate'] as String),
